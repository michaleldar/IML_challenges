...
if __name__ == '__main__':
    ...
    test_set = load_test_set("datasets/test_set_week_3.csv")
    ...
    print("score is:")
    print(estimator._loss(np.array(test_X), np.array(test_y)))
    # print(estimator.estimator_.score(np.array(test_X[:, :6]), np.array(test_y)))
